...
const MODULE_ORDER = ['FRAMEWORK', 'ON-TYPE', 'SUGGESTIONS', 'TRENDING NOW', 'RECENT SEARCHES', 'RUNTIME ERRORS', 'CACHE & STATE', 'SEARCH INPUT ROBUSTNESS', 'ON-ENTER', 'RELATED SEARCHES', 'FILTERS & FACETS', 'SORTING', 'BARCODE NAVIGATION', 'ON-TYPE ANALYTICS', 'SUGGESTIONS ANALYTICS', 'ON-ENTER ANALYTICS'];
